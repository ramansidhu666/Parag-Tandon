<%@ Page Title="" Language="C#" MasterPageFile="~/PropertyNew.Master" AutoEventWireup="true"   CodeBehind="PrivacyPolicy.aspx.cs" Inherits="Property.PrivacyPolicy" %>
    ...
    <div class="wrapper_new">
        <div class="privacy_policy">
            ...
            <div class="cal_new_cls">
                ...
                <p>This website functionality requires/requests users to provide contact information (such as their email address) and personal information (such as their names, address phone numbers, and property details). The user's contact and personal information is used to contact said user when necessary and requested but is primarily used to collect personal information necessary to effectively market and to sell the property of sellers, to locate, assess and qualify properties for buyers and to otherwise provide professional services to clients and customers.</p>
                <h3>Information Collection and Use</h3>
                <p>When subscribing to a newsletter or filling out a form, as appropriate, we collect the information you enter, including but not limited to, your name, email address, mailing address, phone number or other details to help you with your experience.
                <br/>
...
However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.
            ...
            <h3>Canada Anti-Spam Law (CASL) </h3>
            <p>CASL is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.
...
To be in accordance with CASL we agree to the following:
     ...
     <h3>Opt-Out</h3>
     <p>This website provides users the opportunity to opt-out from our mailing list from their accounts. To do this, click on our 'Unsubscribe' link found on the following pages: Neighborhood Buzzer/Home Worth/Dream Home/FREE Real Estate Reports. You will be automatically removed from our subscription list upon unsubscribing.</p>
     ...
     <p>We may disclose personal information when required by law or in the good-faith belief that such action is necessary in order to conform to the edicts of the law or comply with a legal process serviced on our website.
     </p>
     <h3>Contacting Us</h3>
     <p>If you have any questions regarding our privacy policy please send us an email at info@CityAgent.caand we will be pleased to assist.</p>
